<div class="page-header">
  <br><h1>Review Purchase Order Requests <small>deny or approve requests and generate invoices</small></h1>
</div>
<br>
...
<!--		<td><?= $step1['orgTitle']; ?></td> -->
		...
		<td>
			...
			<a href="/po/loadpo/<?= $po['pouid']; ?>" class="btn btn-danger">Download</a>
			<a href="/po/loadpo/<?= $po['pouid']; ?>" class="btn btn-primary">Email</a>
		</td>
	</tr>	
	<?php } ?>
</table>
